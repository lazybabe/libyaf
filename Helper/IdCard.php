...
class IdCard
{
    static function mainLand($idcard){
    ...
    static function hongKong($idcard){
    }

    static function macau($idcard){
    }

    /***Y＝X1＋9×X2＋8×D2＋7×D3＋6×D4＋5×D5＋4×D6＋3×D7＋2×D8＋1×D9***/
    static function taiwan($idcard){
    ...
    static function isIdCard($identity) {
